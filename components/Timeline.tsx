...
export const Timeline: React.FC = () => {
  ...
  useEffect(() => {
    const handleScroll = () => {
      ...
      // We start filling when the top of the section is near the middle of the viewport
      ...
      <div className="max-w-6xl mx-auto px-4 relative z-10">
        <div className="text-center mb-24">
          <div className="inline-flex items-center gap-2 mb-4 px-3 py-1 border border-orange-500/30 bg-orange-500/10 rounded-full">
            ...
            <span className="font-mono text-orange-500 text-xs tracking-widest uppercase">System Architecture</span>
          </div>
                ...
                >
                  ...
                  <div className="absolute left-8 md:left-1/2 transform -translate-x-1/2 z-10">
                    <div className={`relative w-20 h-20 flex items-center justify-center transition-all duration-500 ${isActive ? 'scale-110' : 'scale-100'}`}>
                      ...
                      {/* Outer Rotating Ring (Only current) */}
                      {isCurrent && (
